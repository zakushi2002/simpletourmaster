...
@WebServlet(urlPatterns = {"/admin/createnewtour"})
public class CreateNewTour extends HttpServlet{
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		resp.setContentType("text/html");
		req.setCharacterEncoding("UTF-8");
		resp.setCharacterEncoding("UTF-8");
		RequestDispatcher rq = req.getRequestDispatcher("/admin/createnewtour.jsp");
		rq.forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		boolean isSuccess = service.createTour(titleTour, categoryID, contentTour, scheduleTour, priceTour, start, end, maxSeat, startingGate, pathPhotoTour, saleOff, status);
		if (isSuccess)
		{
	...
	public static final String REGISTER = "/admin/createnewtour.jsp";
}
