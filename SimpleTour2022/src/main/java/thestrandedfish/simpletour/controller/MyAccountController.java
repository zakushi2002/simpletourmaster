...
public class MyAccountController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rq = req.getRequestDispatcher("/views/myaccount.jsp");
		rq.forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String oldPassword = req.getParameter("oldPasswordAccount");
		String oldName = req.getParameter("oldNameAccount");
		...
		Account account = new Account(phoneAccount, null, null, null, roleAccount, statusAccount);
		if (passwordAccount == null)
		{
			account.setPasswordAccount(oldPassword);
		}
		else
		{
		...
		if (nameAccount == null)
		{
			account.setNameAccount(oldName);
		}
		else 
		{
