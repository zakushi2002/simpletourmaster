            ...
            <section class="offer-blog">
                <div class="wrap-offer-blog">
                    ...
                    <div class="blog-container">
                        <div class="item-1">
                          <a href="" class="card1">
                            <div class="thumb" style="background-image: url(./basic/assets/img/slider/thumnail-dac-san-hue.jpg);"></div>
                            ...
                            <article>
                              <h1>Top 30 Hue Specialty Dishes The Essence of Cuisine of the Ancient Capital</h1>
                        ...
                        <div class="item-2">
                          <a href="" class="card1">
                            <div class="thumb" style="background-image: url(./basic/assets/img/slider/dac-san-quang-ninh-2.webp);"></div>
                            <article>
                              <h1>9 Quang Ninh specialties to eat is to remember, as gifts</h1>
                              <span class="date-submitted">20-10-2022</span>
                        ...
                        <div class="item-3">
                          <a href="" class="card1">
                            <div class="thumb" style="background-image: url(./basic/assets/img/slider/mon-ngon-truyen-thong-Ha-Noi.jpg);"></div>
                            <article>
                              <h1>Created by You, July Edition</h1>
                              <p>Com - The beauty of Hanoi's long-standing culinary culture </p>
                              <span class="date-submitted">20-10-2022</span>
                            </article>
                          </a>
                        </div>
                        <div class="item-4">
                          <a href="" class="card1">
                            <div class="thumb" style="background-image: url(./basic/assets/img/slider/rsh3osfrpftjjpddll0t.webp);"></div>
                            <article>
                              <h1>15 Delicious Can Tho Dishes Rich in Western Flavors</h1>
                              <p>Not having eaten all these 15 delicious dishes in Can Tho is considered as not worthy of the title "real god"!</p>
                              <span class="date-submitted">20-10-2022</span>
                            </article>
                          </a>
                        </div>
                        <div class="item-5">
                          <a href="" class="card1">
                            <div class="thumb" style="background-image: url(./basic/assets/img/slider/qjlgu8hvyzh92izevdfg.webp);"></div>
                            <article>
                              <h1>25 Famous Da Lat Specialty Dishes You Shouldn't Miss</h1>
                              <span class="date-submitted">20-10-2022</span>
                            </article>
                          </a>
                        </div>
                        <div class="item-6">
                          <a href="" class="card1">
                            ...
                            <article>
                              <h1>36 Da Nang Specialty Dishes Hard to Refuse</h1>
