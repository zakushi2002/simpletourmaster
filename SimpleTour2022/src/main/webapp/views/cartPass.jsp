                ...
                <form action="pay">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>${item.tour.idTour}</td>
                                <td> <img src="${item.tour.pathPhotoTour }" alt=""> ${item.tour.titleTour }</td>
                                <td><p><span><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${item.unitPrice}" /></span></p></td>
                                <td><input style="width: 70px;outline:none;" type="number" value="${item.quantity}" size="100" /></td>
                    ...
                    <div style="text-align: right;" class="price-total">
                        <p style="font-weight: bold;">Total Price: <span><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${cart.getTotal()}" /></span>VND</p>
                        <p style="font-weight: bold;">Total Price: <span class="total_price_usd">${cart.getIntForTotal(cart.getTotal())}</span>USD</p>
                    </div>
                    <input type="hidden" name="total-price" value="${cart.getIntForTotal(cart.getTotal())}" />
