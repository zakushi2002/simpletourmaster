...
form.addEventListener('submit',(e)=>{
    ...
    if(username.value.length >= 9 && password.value.length >= 6  && text.classList.contains("strong")==true && email.classList.contains("valid")==true && conpassword.classList.contains("valid")==true && phone.value.length >= 9 && phone.classList.contains("valid")==true) {
